...
* Traction, skidding, drifting, etc.
...
Christensen, Christopher. /Personal email between the author (Macoy Madson), Andy Gavin (co-founder of Naughty Dog), and Christopher Christensen (software engineer of Jak 3's dune buggy system)/. 2019-08-08.
